...
def compute(X: list, Y: list, domain: list):
    ...
    """
    Note from Gus:
    This is not as straightforward a process as I first assumed. We are looking to
    implement a function for computing interaction information (or 'amounts of
    information', or co-information), the generalization of mutual information to
    N variables.

    A python library already exists covering this area.
    https://infotopo.readthedocs.io/en/latest/index.html

    The three-variable case is simple to implement given an implementation for
